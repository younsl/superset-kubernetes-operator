...
import (
	...
	"github.com/apache/superset-kubernetes-operator/internal/controller"
...
func main() {
	...
	//
	// To use certificates managed by cert-manager, enable the following kustomize components:
